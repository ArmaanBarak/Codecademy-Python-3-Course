...
# Coin Flip game function, guess the output
...
# Higher card game function, guess if you have a higher number card
def higher_card(bet):
    #Makes sure your bet was above 0
    if bet <= 0:
        print("------------------")
    ...
    print("Computer's card was " + str(computer))
...
# Cho Han game function, guess the sum of rolling two dices (even or odd)
...
# Roulette game function, guess where does the wheel lands?
# This doesn't simulate the game completely but some part of it
